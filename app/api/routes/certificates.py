...
<head>
  ...
  <title>Certificate Verification - Valases</title>
  <style>
...
<body>
  <div class="wrap">
    <div class="card">
      <img class="logo" src="/assets/brand/valases-logo.png" alt="Valases" />
      <h1>Certificate Verified</h1>
      <div class="sub">This certificate is active and issued by Valases.</div>
      <div class="grid">
